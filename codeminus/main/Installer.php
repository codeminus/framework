 ...
 * Default page title
 * @var string
 * @see codeminus/main/View.php for more information
 */
...
/**
 * Default email address to be used as default sender on codeminus\util\Email
 * @var string email address
 */
const DEFAULT_EMAIL_SENDER_ADDRESS = '';

/**
 * Default email owner's name to be used as default sender on codeminus\util\Email
