...
FILE;
    ...
    public static function getInvironment() {
        return str_replace('/org/codeminus/main/Installer.php', '', $_SERVER['SCRIPT_NAME']);
    }
    ...
    <body>
        <div class="header clearFix">
            <header class="">
                ...
                <div class="floatRight bold">Installer v1.0</div>
            </header>
        </div>
        <div class="root">
            ...
            <?php if (!isset($_POST['cmd'])) { ?>
                <form name="configForm" action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST">
                    <input type="hidden" name="DEV_ENVIRONMENT" value="<?php echo Installer::getInvironment() ?>" />
                    <section class="default-container">
                        <header>
                    ...
                    <section class="default-container">
                        ...
                        <section>
                            ...
                            <input type="text" disabled value="<?php echo Installer::getInvironment() ?>" id="DEV_ENVIRONMENT" class="medium" />
            ...
            <?php } else { ?>
                ...
                <section class="default-container">
                    ...
                    <section>
                        ...
                        <a href="<?php echo Installer::APP_ROOT?>" class="btn btn-blue">Test Installation</a>
                    </section>
                </section>
