...
class RecordListViewer {
    ...
    public function setFirstPageButtonImage($source, $alt = null) {
        if(!isset($alt)) $alt = $this->dictionary->text(util\Dictionary::FIRST_PAGE);
    ...
    public function setPreviousPageButtonImage($source, $alt = null) {
        if(!isset($alt)) $alt = $this->dictionary->text(util\Dictionary::PREV_PAGE);
    ...
    public function setNextPageButtonImage($source, $alt = null) {
        if(!isset($alt)) $alt = $this->dictionary->text(util\Dictionary::NEXT_PAGE);
    ...
    public function setLastPageButtonImage($source, $alt = null) {
        if(!isset($alt)) $alt = $this->dictionary->text(util\Dictionary::LAST_PAGE);
    ...
    public function getFirstPageButton($title = null){
        ...
        if(!isset($title)) $title = $this->dictionary->text(util\Dictionary::FIRST_PAGE);
        
        return util\HTML::link(
                $this->getPageLinkSource(1),
    ...
    public function getPreviousPageButton($title = null){
        ...
        if(!isset($title)) $title = $this->dictionary->text(util\Dictionary::PREV_PAGE);
        
        return util\HTML::link(
                $this->getPageLinkSource($this->recordList->getPreviousPage()),
    ...
    public function getNextPageButton($title = null){
        ...
        if(!isset($title)) $title = $this->dictionary->text(util\Dictionary::NEXT_PAGE);
        
        return util\HTML::link(
                $this->getPageLinkSource($this->recordList->getNextPage()),
    ...
    public function getLastPageButton($title = null){
        ...
        if(!isset($title)) $title = $this->dictionary->text(util\Dictionary::LAST_PAGE);
        
        return util\HTML::link(
                $this->getPageLinkSource($this->recordList->getTotalPages()),
