...
abstract class Table {
     ...
     * @return array
     * @param int $operation DBTable::INSERT, DBTable::UPDATE, DBTable::DELETE
     * @throws ExtException
     */
     ...
     * @return boolean
     * @param int $operation DBTable::UPDATE, DBTable::DELETE
    ...
    public function createRecordList($fields = '*', $whereClause = null, $currentPage = 1, $recordsPerPage = DEFAULT_RPP){
        ...
        //Stores RecordList result set into DBTable own sqlResult so it can be handled directly.
    ...
    /**
     * Last DBRecordList object created
     * @return DBRecordList or null if there's none
     */
     ...
     * be accessed by DBTable (its super class). Define them with, at least, PROTECTED access level
